<template>
  <div class="container">
    ...
    <div class="header-container" v-if="!mostrarEspecialidad">
      <h1>AGREGAR ESPECIALIDAD</h1>
      <!-- Botón para enviar el formulario -->
      <button @click="submitForm" class="action-button" v-if="!mostrarEspecialidad">GUARDAR</button>
    </div>
    <table class="data-table" v-if="!mostrarEspecialidad">
      <tr>
      ...
      <tr>
        ...
        <td>
          <input id="modalidad" v-model="formData.modalidad" type="text" readonly />
        </td>
      </tr>
      <tr>
...
export default {
  ...
  data() {
    return {
      formData: {
        programa_estudio: "",
        ciclo_formativo: "AXULIAR-TÉCNICO",
  ...
  methods: {
      ...
      if (this.isFormValid()) {
        fetch("http://127.0.0.1:8000/api/especialidad", {
          ...
          .then((data) => {
            ...
            this.alert_save("Especialidad Agregada - Ingrese Sus Unidades", "success");
    ...
    isFormValid() {
      return (
        this.formData.programa_estudio &&
